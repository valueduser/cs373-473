...
public class MaintDetailsTest {
    ...
    public void testListMaintRequestsForFacility() {
        boolean itWorked = false;
        ArrayList<MaintRequest> requests = details.listMaintRequestsForFacility(fac.getFacilitySerialNumber());
        if (requests != null){
            itWorked = true;
        }
        assertEquals(itWorked, false);
    ...
    public void testListMaint() {
        boolean itWorked = false;
        ArrayList<MaintRequest> requests = details.listMaint(fac.getFacilitySerialNumber(), " ");
        if (requests != null){
            itWorked = true;
        }
        assertEquals(itWorked, false);
    ...
    public void testListFacilityProblems() {
        boolean itWorked = false;
        ArrayList<MaintRequest> requests = details.listFacilityProblems(fac.getFacilitySerialNumber());
        if (requests != null){
            itWorked = true;
        }
        assertEquals(itWorked, false);
